...
class ProductionAgent(PubSubMixin, OperationAgent):
    ...
    async def setup(self):
        ...
        self.csv_writer.writerow(['Data', 'Quantidade Produzida'])
...
with open('fryer_data.csv', mode='w', newline='') as csv_file:
    fieldnames = ['Data', 'Quantidade Produzida']
    ...
    while True:
        ...
        writer.writerow({'Data': current_time, 'Quantidade Produzida': quantidade_produzida})
        time.sleep(5)
